...
import PropertyNames from '../container/propertyNames';
    ...
    return (
      <ScrollView style={Styles.slideContainer}>
        ...
        <View style={Styles.charNamesContainer}>
          {movieDetails.characters.map((item, index) => (
            <PropertyNames
              episodeId={movieDetails.episode_id}
        ...
        <View style={Styles.charNamesContainer}>
          {movieDetails.planets.map((item, index) => (
            <PropertyNames
              episodeId={movieDetails.episode_id}
              slideIndex={slideIndex}
              type={CONSTANTS.PLANETS}
              url={item}
              key={index}
            />
          ))}
        ...
        <View style={Styles.charNamesContainer}>
          {movieDetails.starships.map((item, index) => (
            <PropertyNames
              episodeId={movieDetails.episode_id}
              slideIndex={slideIndex}
              type={CONSTANTS.STARSHIPS}
              url={item}
              key={index}
            />
          ))}
